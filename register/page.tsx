...
function RegisterContent() {
    ...
    return (
        <div className="flex flex-col h-screen justify-center items-center bg-white dark:bg-slate-900">
            <div className="max-w-sm mx-auto md:px-10 p-4 w-full">
                <div>
                    ...
                    {/* Referral Badge */}
                    {showReferralBadge && (
                        <div className="mb-4 p-2 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg text-center animate-fadeOut">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <input
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-[#1e1e1e] text-black dark:text-white focus:outline-none focus:ring-1 focus:ring-gray-500 placeholder-gray-500"
                                id="email"
                                name="email"
                                type="email"
                        ...
                        <div className="space-y-2">
                            <div className="relative">
                                <input
                                    className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-[#1e1e1e] text-black dark:text-white focus:outline-none focus:ring-1 focus:ring-gray-500 placeholder-gray-500 pr-12"
                                    id="password"
                                    name="password"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="font-semibold w-full rounded-full bg-black text-white py-3 px-4 shadow-lg hover:bg-gray-900 active:scale-[0.97] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                        >
...
export default function RegisterPage() {
    return (
        <Suspense fallback={
            <div className="flex flex-col gap-3 justify-center items-center h-screen bg-white dark:bg-dark2">
