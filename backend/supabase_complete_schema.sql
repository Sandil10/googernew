...
-- Table: goog_subscribes (for Write a Goog post subscriptions)
...
-- Table: goog_share_logs (for tracking shares per user per post)
...
-- Table: goog_reports (for reporting posts)
