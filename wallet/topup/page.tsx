                    ...
                    <div className="px-4 pt-2 border-b border-gray-100 dark:border-slate-800">
                        <div className="flex items-center gap-2 overflow-x-auto">
                            <button
                                ...
                                className={`px-4 pb-3 text-sm font-bold transition-all border-b-2 whitespace-nowrap ${activeTab === 'topup'
                            ...
                            <button
                                ...
                                className={`px-4 pb-3 text-sm font-bold transition-all border-b-2 whitespace-nowrap ${activeTab === 'pending'
                                    ? 'text-blue-500 border-blue-500'
                                    : 'text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-4 pb-3 text-sm font-bold transition-all border-b-2 whitespace-nowrap ${activeTab === 'complete'
                                    ? 'text-blue-500 border-blue-500'
                                    : 'text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400'
                                    }`}
                            >
                    ...
                    <div className="p-6 md:p-12 min-h-[400px]">
                        {activeTab === 'topup' && (
                            <div className="animate-fade-in max-w-md mx-auto text-center">
                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Topup Coins</h4>
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-3">
                                        <label className="block text-sm font-bold text-gray-900 dark:text-white">Enter Coin Amount</label>
                                ...
                                <div className="border-t border-gray-100 dark:border-slate-800 my-10"></div>

                                <div className="text-left">
                                    <p className="font-bold text-gray-900 dark:text-white mb-4 text-sm">Recent Transactions</p>
                        ...
                        {(activeTab === 'pending' || activeTab === 'complete') && (
                            <div className="animate-fade-in py-10 text-center text-gray-500 dark:text-gray-400 font-bold">
