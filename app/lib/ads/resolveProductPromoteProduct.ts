...
const mergeProductPromoteOverlay = (source: any, realProduct: any, resolvedId: string) => {
  ...
  return {
    ...resolvedProduct,
    id: resolvedProduct.id ?? resolvedId,
    product_id: resolvedProduct.product_id ?? resolvedId,
    productId: resolvedProduct.productId ?? resolvedId,
    linked_product_id: resolvedProduct.linked_product_id ?? resolvedId,
    linked_product_share_code: resolvedProduct.linked_product_share_code ?? source?.linked_product_share_code ?? resolvedProduct.product_code,
    linked_product_code: resolvedProduct.linked_product_code ?? source?.linked_product_code ?? resolvedProduct.product_code,
    adId: source?.adId || source?.ad_id || adId,
    ad_id: source?.ad_id || source?.adId || adId,
    campaign_type: campaignType,
    is_sponsored: true,
    ...
    shareCode: shareCode || productShareCode || resolvedId,
    share_code: shareCode || productShareCode || resolvedId,
    user_liked: source?.user_liked ?? resolvedProduct.user_liked,
    likes_count: source?.likes_count ?? source?.likeCount ?? resolvedProduct.likes_count,
    views_count: source?.views_count ?? source?.viewCount ?? resolvedProduct.views_count,
    comments_count: source?.comments_count ?? source?.commentCount ?? resolvedProduct.comments_count,
    shares_count: source?.shares_count ?? source?.shareCount ?? resolvedProduct.shares_count,
    ad_coin_collected: source?.ad_coin_collected ?? source?.coinCollected ?? resolvedProduct.ad_coin_collected,
    ad_like_locked: source?.ad_like_locked ?? resolvedProduct.ad_like_locked,
  };
};
