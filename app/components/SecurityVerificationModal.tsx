                ...
                <div className="p-6">
                    ...
                    <div className="space-y-3 mb-8 bg-[#0d1421] p-5 rounded-2xl border border-gray-800/50">
                        ...
                        {transaction?.buyerId && transaction?.sellerId && (
                            <>
                                <div className="flex items-center justify-between mb-4 border-t border-gray-800/50 pt-4">
                                    <span className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Buyer ID</span>
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm font-bold text-gray-400 uppercase">-</span>
                                        <span className="text-sm font-bold text-white tracking-wide">{transaction.buyerId}</span>
                                    </div>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Seller ID</span>
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm font-bold text-gray-400 uppercase">-</span>
                                        <span className="text-sm font-bold text-white tracking-wide">{transaction.sellerId}</span>
                                    </div>
                                </div>
                            </>
                        )}
