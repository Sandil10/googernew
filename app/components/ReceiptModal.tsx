    ...
    return (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-300">
            ...
            <div className="relative bg-[#1a2b4b] border border-white/10 rounded-[3rem] w-full max-w-sm overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
                ...
                <div className="p-8 pb-32">
                    <div className="text-center mb-8">
                        <div className="w-16 h-16 bg-blue-500/20 border border-blue-500/50 rounded-full flex items-center justify-center mx-auto mb-4">
                            <IonIcon name="receipt" className="text-3xl text-blue-400" />
                        </div>
                        <h3 className="text-xl font-black text-white italic uppercase tracking-[0.2em] mb-1">Transaction Receipt</h3>
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest leading-relaxed">Verified and Confirmed by system</p>
                    </div>
                    ...
                    <div className="mt-8 bg-white/[0.03] border border-white/5 p-4 rounded-2xl flex flex-col items-center">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#1a2b4b] to-transparent">
                    <button
                        onClick={() => generateTransactionReceipt(transaction, currentUser)}
                        className="w-full h-14 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-95 shadow-xl shadow-blue-600/20 group"
                    >
                        <IonIcon name="download-outline" className="text-xl group-hover:scale-110 transition-transform" />
                        <span className="text-[10px] font-black uppercase tracking-[0.2em]">Download Receipt</span>
                    </button>
                    <button
                        onClick={onClose}
                        className="w-full py-3 text-[9px] text-slate-500 font-bold uppercase tracking-widest hover:text-white transition-colors"
                    >
                        Close
                    </button>
                </div>
