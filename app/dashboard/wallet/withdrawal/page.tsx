                ...
                <div className="p-6 md:p-8 min-h-[400px]">
                    {activeTab === 'withdrawal' && (
                        <div className="max-w-md mx-auto">
                            ...
                            {/* Balance Indicator */}
                            <div className="bg-[#070707] border border-gray-700 rounded-xl p-5 mb-8 relative overflow-hidden flex flex-col items-center justify-center">
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-center text-gray-400 text-xs font-semibold mb-3 tracking-wider uppercase">ID Verification Name</label>
                                        <input
                                            type="text"
                                            value={idVerificationName}
                                            onChange={(e) => setIdVerificationName(e.target.value)}
                                            className="w-full bg-[#030303] border border-gray-700/50 rounded-xl px-4 py-3 text-white text-center text-lg font-bold focus:outline-none focus:ring-1 focus:ring-white/30 shadow-inner transition-all hover:bg-[#0b0b0b]"
                                            placeholder="Enter Name"
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-center text-gray-400 text-xs font-semibold mb-3 tracking-wider uppercase">Subscription Type</label>
                                        <div className="relative">
                                            <select
                                                value={subscriptionType}
                                                onChange={(e) => setSubscriptionType(e.target.value)}
                                                className="w-full bg-[#030303] border border-gray-700/50 rounded-xl px-4 py-3 text-white text-center text-sm font-bold focus:outline-none focus:ring-1 focus:ring-white/30 shadow-inner appearance-none transition-all hover:bg-[#0b0b0b] cursor-pointer"
                                            >
                                    ...
                                    <div>
                                        <label className="block text-center text-gray-400 text-xs font-semibold mb-3 tracking-wider uppercase">Center Box</label>
                                        <input
                                            type="text"
                                            value={center}
                                    ...
                                    <div>
                                        <label className="block text-center text-gray-400 text-xs font-semibold mb-3 tracking-wider uppercase">Withdrawal Amount</label>
                                        <input
                                            type="text"
                                            value={amount}
