    ...
    return (
        <div className="flex flex-col min-h-[100dvh] justify-center items-center bg-black py-12">
            <div className="max-w-md mx-auto md:px-10 p-4 w-full">
                <div className="bg-black p-8 rounded-3xl border border-gray-800 shadow-[0_0_50px_-12px_rgba(255,255,255,0.08)]">
                    {/* Logo */}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        <div className="rounded-full border border-gray-800 bg-[#121212] p-1">
                            <div className="relative grid grid-cols-2 text-[11px] font-bold">
                                <span
                                    className={`absolute inset-y-1 w-[calc(50%-0.25rem)] rounded-full bg-white shadow-lg shadow-black/30 transition-transform duration-300 ${
                                        isSeller ? "translate-x-[calc(100%+0.5rem)]" : "translate-x-0"
                                    }`}
                                />
                                <button
                                    type="button"
                                    onClick={() => {
                                        if (isSeller) toggleMode();
                                    }}
                                    className={`relative z-10 rounded-full px-3 py-2 transition-colors ${!isSeller ? "text-black" : "text-gray-500 hover:text-white"}`}
                                >
                                    User
                                </button>
                                <button
                        ...
                        <div>
                            <input
                                className="w-full px-4 py-3 rounded-xl border border-gray-800 bg-[#121212] text-white focus:outline-none focus:ring-1 focus:ring-gray-500/40 placeholder-gray-500 text-sm"
                                id="email"
                                name="email"
                                type="email"
                        ...
                        <div className="space-y-1">
                            <div className="relative">
                                <input
                                    className="w-full px-4 py-3 rounded-xl border border-gray-800 bg-[#121212] text-white focus:outline-none focus:ring-1 focus:ring-gray-500/40 placeholder-gray-500 pr-12 text-sm"
                                    id="password"
                                    name="password"
                        ...
                        <div className="flex items-center pt-1">
                            <input
                                ...
                                name="terms"
                                type="checkbox"
                                className="h-4 w-4 bg-[#121212] border-gray-800 rounded text-gray-300 focus:ring-gray-500"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="font-bold w-full rounded-full bg-gray-200 text-black py-3 px-4 shadow-[0_14px_30px_rgba(255,255,255,0.08)] hover:bg-white active:scale-[0.97] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed mt-2 text-sm"
                        >
                        ...
                        <div className="text-center mt-4">
                            ...
                            <Link href="/" className="text-red-500 hover:text-red-400 text-xs font-bold">
                                Login
                            </Link>
                        </div>
