                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#0d1421] border border-gray-700/50 rounded-xl px-4 py-3 text-white text-center text-lg font-bold focus:outline-none focus:ring-1 focus:ring-blue-500/50 shadow-inner transition-all hover:bg-[#111a2b]"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                className="w-full bg-[#0d1421] border border-gray-700/50 rounded-xl px-4 py-3 text-white text-center text-sm font-bold focus:outline-none focus:ring-1 focus:ring-blue-500/50 shadow-inner appearance-none transition-all hover:bg-[#111a2b] cursor-pointer"
                                            >
